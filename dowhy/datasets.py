...
def linear_dataset(beta, num_common_causes, num_samples, num_instruments=0,
    ...
    treatments = [f"v{str(i)}" for i in range(0, num_treatments)]
    outcome = "y"
    ...
    instruments = [f"Z{str(i)}" for i in range(0, num_instruments)]
    frontdoor_variables = [
        f"FD{str(i)}" for i in range(0, num_frontdoor_variables)
    ]
...
def simple_iv_dataset(beta, num_samples,
    ...
    treatments = [f"v{str(i)}" for i in range(0, num_treatments)]
    outcome = "y"
    common_causes = [f"W{str(i)}" for i in range(0, num_common_causes)]
